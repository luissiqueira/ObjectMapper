...
ObjectMapper is a framework written in Swift created by [Hearst-DD](https://github.com/Hearst-DD/ObjectMapper) that makes it easy for you to convert your Model objects (Classes and Structs) to and from JSON. 
